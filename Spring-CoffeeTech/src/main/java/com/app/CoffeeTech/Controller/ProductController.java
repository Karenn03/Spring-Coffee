...
import com.app.CoffeeTech.Business.ProductBusiness;
...
public class ProductController {
    ...
    public ResponseEntity<Map<String, Object>> findAll(Pageable pageable) {
        try {
            Page<ProductDTO> ProductosDTOPage = productBusiness.findAll(pageable);
    ...
    public ResponseEntity<Map<String, Object>> findById(@PathVariable Long id) {
        try {
            ProductDTO productDTO = productBusiness.findById(id);
            return new ResponseEntity<>(
    ...
    // Add Products
    @PostMapping("/add")
    public ResponseEntity<Map<String, Object>> add(@Validated @RequestBody ProductDTO productDTO) {
        try {
            productBusiness.add(productDTO);
            return new ResponseEntity<>(
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable Long id, @Validated @RequestBody ProductDTO productDTO) {
        try {
            productBusiness.update(id, productDTO);
            return new ResponseEntity<>(
                    ResponseHttpApi.responseHttpAction(
                            ResponseHttpApi.CODE_OK,
