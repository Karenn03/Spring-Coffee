...
import com.app.CoffeeTech.Business.OrderBusiness;
...
public class OrderController {
    ...
    public ResponseEntity<Map<String, Object>> findAll(Pageable pageable) {
        try {
            Page<OrderDTO> pedidosDTOPage = orderBusiness.findAll(pageable);
    ...
    public ResponseEntity<Map<String, Object>> findById(@PathVariable Long id) {
        try {
            OrderDTO orderDTO = orderBusiness.findById(id);
            return new ResponseEntity<>(
    ...
    // Add Order
    @PostMapping("/add")
    public ResponseEntity<Map<String, Object>> add(@Validated @RequestBody OrderDTO orderDTO) {
        try {
            orderBusiness.add(orderDTO);
            return new ResponseEntity<>(
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable Long id, @Validated @RequestBody OrderDTO orderDTO) {
        try {
            orderBusiness.update(id, orderDTO);
            return new ResponseEntity<>(
                    ResponseHttpApi.responseHttpAction(
                            ResponseHttpApi.CODE_OK,
