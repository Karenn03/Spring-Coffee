...
import com.app.CoffeeTech.Business.RoleBusiness;
...
public class RoleController {
    ...
    public ResponseEntity<Map<String, Object>> findAll(Pageable pageable) {
        try {
            Page<RoleDTO> rolesDTOPage = roleBusiness.findAll(pageable);
    ...
    // Add Role
    @PostMapping("/add")
    public ResponseEntity<Map<String, Object>> add(@Validated @RequestBody RoleDTO roleDTO) {
        try {
            roleBusiness.add(roleDTO);
            return new ResponseEntity<>(
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable Long id, @Validated @RequestBody RoleDTO roleDTO) {
        try {
