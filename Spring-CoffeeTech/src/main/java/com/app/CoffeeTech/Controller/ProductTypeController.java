...
import com.app.CoffeeTech.Business.ProductTypeBusiness;
...
public class ProductTypeController {
    ...
    public ResponseEntity<Map<String, Object>> findAll(Pageable pageable) {
        try {
            Page<ProductTypeDTO> TipoProductoDTOPage = productTypeBusiness.findAll(pageable);
    ...
    public ResponseEntity<Map<String, Object>> findById(@PathVariable Long id) {
        try {
            ProductTypeDTO productTypeDTO = productTypeBusiness.findById(id);
            return new ResponseEntity<>(
    ...
    // Add Product Type
    @PostMapping("/add")
    public ResponseEntity<Map<String, Object>> add(@Validated @RequestBody ProductTypeDTO productTypeDTO) {
        try {
            productTypeBusiness.add(productTypeDTO);
            return new ResponseEntity<>(
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable Long id, @Validated @RequestBody ProductTypeDTO productTypeDTO) {
        try {
            productTypeBusiness.update(id, productTypeDTO);
            return new ResponseEntity<>(
                    ResponseHttpApi.responseHttpAction(
                            ResponseHttpApi.CODE_OK,
