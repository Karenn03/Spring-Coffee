...
import com.app.CoffeeTech.Business.SaleBusiness;
...
public class SaleController {
    ...
    public ResponseEntity<Map<String, Object>> findAll(Pageable pageable) {
        try {
            Page<SaleDTO> ventasDTOPage = saleBusiness.findAll(pageable);
    ...
    public ResponseEntity<Map<String, Object>> findById(@PathVariable Long id) {
        try {
            SaleDTO saleDTO = saleBusiness.findById(id);
            return new ResponseEntity<>(
    ...
    // Add Sale
    @PostMapping("/add")
    public ResponseEntity<Map<String, Object>> add(@Validated @RequestBody SaleDTO saleDTO) {
        try {
            saleBusiness.add(saleDTO);
            return new ResponseEntity<>(
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable Long id, @Validated @RequestBody SaleDTO saleDTO) {
        try {
            saleBusiness.update(id, saleDTO);
            return new ResponseEntity<>(
                    ResponseHttpApi.responseHttpAction(
                            ResponseHttpApi.CODE_OK,
