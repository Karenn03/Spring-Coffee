...
import com.app.CoffeeTech.Business.DeliveryBusiness;
...
public class DeliveryController {
    ...
    public ResponseEntity<Map<String, Object>> findAll(Pageable pageable) {
        try {
            Page<DeliveryDTO> domicilioDTOPage = deliveryBusiness.findAll(pageable);
    ...
    public ResponseEntity<Map<String, Object>> findById(@PathVariable Long id) {
        try {
            DeliveryDTO deliveryDTO = deliveryBusiness.findById(id);
            return new ResponseEntity<>(
    ...
    // Add Delivery
    @PostMapping("/add")
    public ResponseEntity<Map<String, Object>> add(@Validated @RequestBody DeliveryDTO deliveryDTO) {
        try {
            deliveryBusiness.add(deliveryDTO);
            return new ResponseEntity<>(
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable Long id, @Validated @RequestBody DeliveryDTO deliveryDTO) {
        try {
